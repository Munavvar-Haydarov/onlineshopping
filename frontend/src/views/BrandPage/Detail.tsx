...
const Detail: React.FC<GlobalProps> = ({ sex, bagList }) => {
  return (
    <>
        ...
        <div className="flex justify-center my-5">
          <div className=" flex flex-col md:flex-row md:w-3/4 space-x-10 ">
            <div className=" md:w-[60%] flex flex-col items-center ">
              ...
              <Accordion
                alwaysOpen={true}
                className=" w-full mt-4 p-10 border-none"
              >
                <Accordion.Panel>
              ...
              <div className="flex flex-col pr-10 font-[Helvetica]">
                ...
                <div className="text-xl ">
                  <div className="grid grid-cols-3 text-center border-l">
                    <div className="border border-solid border-l-0 mb-[-1px]">
                      01
                    </div>
                    <div className="border border-solid border-l-0 mb-[-1px]">
                      01
                  ...
                  <div className=" w-full text-center">
                    <Link to={"/Bag"}>
                      <button className="w-3/5 mt-5 p-4 bg-black text-2xl text-white hover:text-gray-400">
                        Add to Bag
                      </button>
                    </Link>
                  </div>
